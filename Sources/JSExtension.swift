...
public class JSExtension: Extension {
    ...
    /// }
    /// ```
    public func registerFilter(_ name: String, script code: String, jsContext: JSContext) {
        super.registerFilter(name, filter: { (value: Any?, params: [Any?]) throws -> Any? in
    ...
    public func registerFilter(_ name: String, script code: String) {
        registerFilter(name, script: code, jsContext: jsContext)
    }
    ...
    /// }
    /// ```
    public func registerSimpleTag(_ name: String, script code: String, jsContext: JSContext) {
        super.registerSimpleTag(name) { (context) -> String in
            try inJSContext(jsContext) { jsContext.evaluateScript(code) }
    ...
    public func registerSimpleTag(_ name: String, script code: String) {
        registerSimpleTag(name, script: code, jsContext: jsContext)
    }
    ...
    /// }
    /// ```
    public func registerTag(_ name: String, script code: String, jsContext: JSContext) {
        super.registerTag(name, parser: { parser, token in
            try inJSContext(jsContext) { jsContext.evaluateScript(code) }
    ...
    public func registerTag(_ name: String, script code: String) {
        registerTag(name, script: code, jsContext: jsContext)
    }
